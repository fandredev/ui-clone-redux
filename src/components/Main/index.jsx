...
import { Container, Debugglable } from "./styled";
    ...
    <Container>
      ...
      <section>
        <figure>
          ...
          <img
            src={centralized}
            alt="Imagem ilustrativa de blocos de cubo mágico"
          />
        </figure>
          <h5>Centralized</h5>
          ...
          <p>
            ...
            capabilities like <strong>undo/redo, state persistence</strong>, and
            much more.
          </p>
      </section>
      <section>
